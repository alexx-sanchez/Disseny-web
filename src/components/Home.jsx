    ...
    render() {
        return (
            <main className="bg-gray-100">
                ...
                <section className="grid md:grid-cols-2 gap-0 items-center bg-gray-300 rounded-none">
                    <header className="flex items-center gap-4 pl-4">
                        <h1 className="text-3xl font-bold mb-0">Campeones del Mundial de Constructores 2024</h1>
                        <img
                ...
                <section className="grid md:grid-cols-2 gap-0 items-center bg-gray-300 rounded-none">
                    <header className="flex flex-col items-center justify-center text-center px-4">
                        <h2 className="text-3xl font-semibold">Seu de McLaren</h2>
